...
class AIAgent:
    ...
    def _run_claude_agent_turn(
        ...
        *,
        ...
        """Forwarder. See ``agent.claude_runtime.run_claude_agent_turn``."""
        from agent.claude_runtime import run_claude_agent_turn
        return run_claude_agent_turn(self, user_message=user_message, original_user_message=original_user_message, messages=messages, effective_task_id=effective_task_id, should_review_memory=should_review_memory)
